...
(defn collection
  [name]
  (str "com.etzhayyim.mizuho." name))

(def cell-specs {
  :potable_water_supply {:legacy-cell "potable-water-supply"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "potable_water_supply")]
     :required-gates common-gates
     :trigger "manifest cell potable_water_supply"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :wastewater_treatment {:legacy-cell "wastewater-treatment"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "wastewater_treatment")]
     :required-gates common-gates
     :trigger "manifest cell wastewater_treatment"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :stormwater_management {:legacy-cell "stormwater-management"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "stormwater_management")]
     :required-gates common-gates
     :trigger "manifest cell stormwater_management"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :greywater_recycling {:legacy-cell "greywater-recycling"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "greywater_recycling")]
     :required-gates common-gates
     :trigger "manifest cell greywater_recycling"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :irrigation_supply {:legacy-cell "irrigation-supply"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "irrigation_supply")]
     :required-gates common-gates
     :trigger "manifest cell irrigation_supply"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :clinical_grade_water_supply {:legacy-cell "clinical-grade-water-supply"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "clinical_grade_water_supply")]
     :required-gates common-gates
     :trigger "manifest cell clinical_grade_water_supply"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
